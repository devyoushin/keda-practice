...
| 문서 | 주제 |
|------|------|
| `install.md` | KEDA 설치 (Helm) |
| `hands-on.md` | 기본 실습 |
| `scaledobject-guide.md` | ScaledObject 개념 및 설정 |
| `scaledjob-guide.md` | ScaledJob 개념 및 설정 |
| `triggerauth-guide.md` | TriggerAuthentication 보안 설정 |
| `prometheus-scaler.md` | Prometheus 메트릭 기반 스케일링 |
